...
| | | **Métrica 2.2: Taxa de Compatibilidade de Plugins** | Painel de administração do Moodle, diretório de plugins — [Ver detalhes](../ferramentas) | [Ver plano de coleta](../portabilidade/#ct-por-04-compatibilidade-de-plugins-e-temas-na-atualizacao-do-moodle) |
